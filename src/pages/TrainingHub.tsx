...
const allRoutes: RouteCard[] = [
  ...
  },
  {
    ...
    description: 'Domina la Clínica de Ventas completa con 23 módulos de entrenamiento',
    icon: Sprout,
  ...
  },
  {
    ...
    description: 'Dos fases: modelo y economía de la alianza para el nivel directivo, y operación completa en campo para la fuerza comercial (perfilamiento, simulador de cuota y calculadora de retorno).',
    icon: Activity,
    color: 'from-secondary to-secondary/80',
    borderColor: 'border-secondary',
    bgColor: 'bg-secondary/10',
